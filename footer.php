        ...
        <p><?php fast_food_truck_credit(); ?> <?php echo esc_html(get_theme_mod('fast_food_truck_footer_copy',__('By Buywptemplate','fast-food-truck'))); ?></p>
            <div class="d-flex justify-content-center align-items-center gap-3 mt-2">
                <?php if ( get_theme_mod('fast_food_truck_footer_facebook_url','') != "" ) {?>
                    <a target="_blank" href="<?php echo esc_attr( get_theme_mod('fast_food_truck_footer_facebook_url','' )); ?>"><i class="fab fa-facebook-f"></i><span class="screen-reader-text"><?php echo esc_html('Facebook', 'fast-food-truck'); ?></span></a>
                <?php }?>
                <?php if ( get_theme_mod('fast_food_truck_footer_twitter_url','') != "" ) {?>
                    <a target="_blank" href="<?php echo esc_attr( get_theme_mod('fast_food_truck_footer_twitter_url','' )); ?>"><i class="fab fa-twitter"></i><span class="screen-reader-text"><?php echo esc_html('Twitter', 'fast-food-truck'); ?></span></a>
                <?php }?>
                <?php if ( get_theme_mod('fast_food_truck_footer_youtube_url','') != "" ) {?>
                    <a target="_blank" href="<?php echo esc_attr( get_theme_mod('fast_food_truck_footer_youtube_url','' )); ?>"><i class="fab fa-youtube"></i><span class="screen-reader-text"><?php echo esc_html('Youtube', 'fast-food-truck'); ?></span></a>
                <?php }?>
                <?php if ( get_theme_mod('fast_food_truck_footer_vimeo_url','') != "" ) {?>
                    <a target="_blank" href="<?php echo esc_attr( get_theme_mod('fast_food_truck_footer_vimeo_url','' )); ?>"><i class="fab fa-vimeo"></i><span class="screen-reader-text"><?php echo esc_html('Vimeo', 'fast-food-truck'); ?></span></a>
                <?php }?>              
              </div>   
        </div>
        <div class="clear"></div>
