		...
		<div class="getting-started__header">
			...
			<div class="row">
					<div class="theme-instruction-block col-md-7">
						<div class="pad-box">
		           	<p><?php esc_html_e( 'The Fast Food Truck is the perfect solution for fast food businesses looking to establish a robust online presence. Designed specifically for food trucks, this theme is ideal for gourmet food trucks, street food vendors, and mobile kitchens. Whether youre running a taco truck, burger truck, pizza truck, sushi truck, BBQ truck, grill truck, seafood truck, fish and chips truck, lobster truck, or shrimp truck, this theme caters to create a perfect website for fast food. The Fast Food Truck WordPress Theme is packed with features to help you showcase your delicious offerings and attract more customers. Its sleek, responsive design ensures your website looks great on any device, providing a seamless browsing experience for users on the go. With dedicated pages for menus, reservations, and online ordering, you can streamline your operations and enhance customer convenience. Highlight your top dishes with the Top Seller section. The Free Food Truck can also be integrated with the popular plugins such as Woocommerce, Contact Form7, Jetpack, Yoast SEO and Product Filter Plugins to give your website more functionality with proper payment gateways and support. Whether youre offering food truck catering or serving delicious street food, the Fast Food Truck WordPress Theme empowers you to create a professional and enticing online presence. Transform your food truck business today and start reaching more customers with this dynamic, feature-rich theme.', 'fast-food-truck' ); ?><p><br>
				        	<ol>
